                ...
                <div style={styles.listCard}>
                    ...
                    <div className="d-block d-md-none premium-mobile-cards-container">
                        {filteredUsers.length === 0 ? (
                            ...
                            filteredUsers.map((u) => (
                                <div key={u._id} className="premium-mobile-card" onClick={() => handleView(u)}>
                                    <div className="card-header-row" style={{justifyContent: 'space-between', alignItems: 'flex-start'}}>
                                        <div className="card-title-container">
                                            <h4 className="card-company-name">{u.name}</h4>
                                            <span className="card-company-code" style={{marginBottom: '8px'}}>{u.designationId?.name || "N/A"} • {u.companyId?.name || "N/A"}</span>
                                            <span
                                                style={{
                                                    padding: '4px 8px',
                                                    borderRadius: '6px',
                                                    ...
                                                    color: u.status === "Active" ? "#065f46" : "#9f1239",
                                                    backgroundColor: u.status === "Active" ? "#d1fae5" : "#fecdd3",
                                                }}>
                                                {u.status}
                                            </span>
                                        </div>
                                        <div style={{display: 'flex', gap: '8px'}}>
                                            <button className="small-action-btn btn-edit" onClick={(e) => { e.stopPropagation(); handleEdit(u); }}>
                                                <EditIcon />
                                            </button>
                                            <button className="small-action-btn btn-delete" onClick={(e) => { e.stopPropagation(); handleDeleteClick(u); }}>
                                                <DeleteIcon />
                                            </button>
                                        </div>
                                    </div>
                                    <div className="card-details-row" style={{paddingTop: '0'}}>
                                        <div className="detail-item">
                                            ...
                                            <span className="detail-text">{u.mobile}</span>
                                        </div>
                                        <div className="detail-item">
                                            <i className="ph-duotone ph-envelope icon-accent"></i>
                                            <span className="detail-text" style={{wordBreak: 'break-all'}}>{u.email}</span>
                                        </div>
                                    </div>
                                </div>
                            ))
