...
const WorkerAnalysisPage = () => {
    ...
    const filteredTickets = tickets.filter((ticket) => {
        // Exclude tickets that have moved past the initial analysis stage
        const statusName = String(getStatusName(ticket)).toLowerCase();
        if (
            statusName.includes("material approved") || 
            statusName.includes("working in progress") || 
            statusName.includes("work completed") ||
