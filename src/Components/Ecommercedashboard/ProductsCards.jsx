...
const ProductsCards = () => {
    useEffect(() => {
        ...
        // Add delay to ensure DOM is ready and jQuery is available
        const timer = setTimeout(() => {
            try {
                const element = document.getElementById("userCountries");
                if (element && window.$ && window.$.fn.vectorMap) {
                ...
                console.warn("Vector map initialization error:", error);
            }
        }, 500);
                                            ...
                                            .map((country, idx) => (
                                                <ListGroupItem
                                                    ...
                                                    <div className="d-flex align-items-center">
                                                        <span className="me-3">
                                                            <i
                                                                className={`flag-icon flag-icon-${country.flag} flag-icon-squared b-r-5 f-s-24`}></i>
                                                        </span>
                ...
                <Card className="top-product-card">
                    ...
                    <CardBody>
                        <div className="table-responsive app-scroll">
                            <Table
                                className="align-middle top-products-table mb-0"
                                striped>
                                <thead>
                                    <tr>
                                        <th>Product</th>
                                ...
                                <li key={index} className="timeline-section ">
                                    ...
                                    <div className="timeline-icon me-3">
                                        <span
                                            ...
                                            <i
                                                className={`ph-duotone ${order.icon} f-s-18 text-white`}></i>
                                        </span>
                                    </div>
                                    ...
                                    <div className="timeline-content flex-grow-1">
                                        <div className="order-timeline-box">
                                            <div className="d-flex justify-content-between align-items-center">
                                                <h6
                                                    className={`text-${order.color} fw-bold mb-0`}>
                                                    {order.status}
                                                </h6>
