            ...
            <div style={styles.container}>
                ...
                <div style={styles.listCard}>
                    ...
                    <div className="d-block d-md-none premium-mobile-cards-container">
                        {filteredTicketStatuses.length === 0 ? (
                            <div style={styles.noData}>No ticket statuses found.</div>
                        ) : (
                            filteredTicketStatuses.map((t) => (
                                <div key={t._id} className="premium-mobile-card" onClick={() => handleView(t)}>
                                    <div className="card-header-row" style={{justifyContent: 'space-between', alignItems: 'center'}}>
                                        <div className="card-title-container">
                                            <h4 className="card-company-name">{t.name}</h4>
                                        </div>
                                        <div style={{display: 'flex', alignItems: 'center', gap: '8px'}}>
                                            ...
                                            <button className="small-action-btn btn-edit" onClick={(e) => { e.stopPropagation(); handleEdit(t); }}>
                                                <EditIcon />
                                            </button>
                                            <button className="small-action-btn btn-delete" onClick={(e) => { e.stopPropagation(); handleDeleteClick(t); }}>
                                                <DeleteIcon />
                                            </button>
                                        </div>
                                    </div>
