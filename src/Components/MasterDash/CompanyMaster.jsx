                ...
                <div style={styles.modalOverlay}>
                    <div
                        ...
                        <div style={styles.modalBody}>
                            {viewData.logo && (
                                <img
                                    src={normalizeImageUrl(viewData.logo)}
                                    alt="Logo"
                ...
                <div style={styles.listCard}>
                    ...
                    <div className="d-none d-md-block">
                        <div style={styles.tableResponsive}>
                            <table style={styles.table} className="responsive-card-table">
                                <thead>
                                    <tr>
                                    ...
                                    {companies.length === 0 ? (
                                        ...
                                        companies.map((c) => (
                                            <tr key={c._id} style={styles.tr}>
                                                <td style={styles.td} data-label="Logo">
                                                    {c.logo ? (
                                                        <img
                                                ...
                                                <td style={styles.td} data-label="Code">
                                                ...
                                                <td style={styles.td} data-label="Contact">
                                                ...
                                                <td
                                                    style={styles.td}
                                                    className="responsive-hide-mobile" data-label="Email">
                                                    {c.email}
                                                </td>
                                                {/* Website Column */}
                                                <td
                                                    style={styles.td}
                                                    className="responsive-hide-mobile" data-label="Website">
                                                    {c.website ? (
                                                        <a
                                                            href={c.website}
                                                            target="_blank"
                                                ...
                                                <td style={styles.tdAction} data-label="ACTIONS">
                                                    <button
                    ...
                    <div className="d-block d-md-none premium-mobile-cards-container">
                        {companies.length === 0 ? (
                            <div style={styles.noData}>No companies found.</div>
                        ) : (
                            companies.map((c) => (
                                <div key={c._id} className="premium-mobile-card" onClick={() => handleView(c)}>
                                    <div className="card-header-row" style={{justifyContent: 'space-between', alignItems: 'flex-start'}}>
                                        <div style={{display: 'flex', alignItems: 'center'}}>
                                            <div className="card-logo-container">
                                                {c.logo ? (
                                                    <img src={normalizeImageUrl(c.logo)} alt="" className="card-logo" />
                                                ) : (
                                                    <div className="card-no-logo" />
                                                )}
                                            </div>
                                            <div className="card-title-container">
                                                <h4 className="card-company-name">{c.name}</h4>
                                                <span className="card-company-code">{c.code}</span>
                                            </div>
                                        </div>
                                        <div style={{display: 'flex', gap: '8px'}}>
                                            <button className="small-action-btn btn-edit" onClick={(e) => { e.stopPropagation(); handleEdit(c); }}>
                                                <EditIcon />
                                            </button>
                                            <button className="small-action-btn btn-delete" onClick={(e) => { e.stopPropagation(); handleDeleteClick(c); }}>
                                                <DeleteIcon />
                                            </button>
                                        </div>
                                    </div>
                                    <div className="card-details-row" style={{paddingTop: '0'}}>
                                        <div className="detail-item">
                                            <i className="ph-duotone ph-phone icon-accent"></i>
                                            <span className="detail-text">{c.mobile || c.phone || 'N/A'}</span>
                                        </div>
                                        <div className="detail-item">
                                            <i className="ph-duotone ph-envelope icon-accent"></i>
                                            <span className="detail-text truncate-text">{c.email || 'N/A'}</span>
                                        </div>
                                        <div className="detail-item">
                                            <i className="ph-duotone ph-globe icon-accent"></i>
                                            <span className="detail-text truncate-text">{c.website || 'N/A'}</span>
                                        </div>
                                    </div>
                                </div>
                            ))
